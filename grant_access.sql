...
-- 3. Gold schema: READ UC2 DQ metrics views
GRANT USE SCHEMA ON SCHEMA mwua_capstone_team3.gold 
  TO `ec20b8a6-556d-4bc7-ba88-81030099a394`;
GRANT SELECT ON SCHEMA mwua_capstone_team3.gold 
  TO `ec20b8a6-556d-4bc7-ba88-81030099a394`;

-- 4. Governance schema: READ + WRITE (app creates & manages these)
...
-- 5. SQL Warehouse access (not executable via SQL — use UI or Permissions API)
